...
def analyze_shot_accuracy_impact():
    ...
    print(f"- {misses_converted:.1f}% fewer missed shots")
    print(f"- {fb_reduction:.2f} fewer fast break goals per 100 shots")
    goals_saved = int(fb_reduction * 25)
    print(f"- That's ~{goals_saved} fewer goals against per season!")
